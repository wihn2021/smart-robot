...
def a_star(grid_map: ndarray, start: Tuple(int, int), goal: Tuple(int, int)) -> Union[List, None]:
    open_set = [(0, start)]
...
def is_clear_path(grid_map: ndarray, start: Tuple(int, int), end: Tuple(int, int)) -> bool:
    dx = end[0] - start[0]
    dy = end[1] - start[1]
...
def get_corner_points(path) -> list:
